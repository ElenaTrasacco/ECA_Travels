    ...
    <div class="container mt-5">
        <div class="row justify-content-center ">
            <div class="col-12 col-md-4 d-flex justify-content-center">
                <form action="{{ route('register') }}" class="form_main" method="POST">
                    @csrf
                    ...
                    <div class="inputContainer">
                        ...
                        <input type="text" class="inputField" id="name" name="name" placeholder="Nome">
                        @error('name')
                    ...
                    <div class="inputContainer">
                        ...
                        <input type="password" class="inputField" id="password_confirmation"
