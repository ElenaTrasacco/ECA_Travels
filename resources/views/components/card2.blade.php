<div class="container-fluid containerLista d-flex justify-content-between shadow favCard">
    ...
    <div class="col-12 col-md-1 d-flex justify-content-end">
        <div title="favourite" class="heart-container">
            {{-- <a href="{{route('dashboard')}}"> --}}
            <input id="favourite" class="checkbox" type="checkbox"  onClick="fav()"></a>
